...
<head>
    ...
    <script src="../module/js/jquery-2.1.1.min.js" type="text/javascript"></script>
    <script src="../module/js/homePage.js" type="text/javascript"></script>
...
<div id="head">
    ...
    <div id="nav">
        ...
        <ul id="nav_ul">
            ...
            <li class="nav_ul_li" onclick="handleClick1()"><a href="#">首页</a></li>
            <li class="nav_ul_li" onclick="handleClick2()"><a href="#">课程介绍</a></li>
...
<iframe id="iframe1" src="homePageCenter.jsp" frameborder="0" width="100%" height="776" scrolling="no"></iframe>
